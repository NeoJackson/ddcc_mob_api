...
require_once ( API_ROOT_PATH . '/baidupush/RequestCore.class.php' );
require_once ( API_ROOT_PATH . '/baidupush/ChannelException.class.php' );
require_once ( API_ROOT_PATH . '/baidupush/BaeBase.class.php' );
